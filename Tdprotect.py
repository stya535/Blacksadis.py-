...
cl = LINETCR.LINE()
cl.login(token="EtCDJPwXWgZVZ9ZY8vG0.9q2iIcfJltjghJCvoSD1Wa.qxIhS7GX/hpJmnGdzb0WMta8EzoFNlz2ZQLhWJTAClA=")
cl.loginResult()
...
kd = LINETCR.LINE()
kd.login(token="EthiVrULEpzbos9vF92a.YrEUBEmpSvXbOCVw0GLL6G.u/tW8Xfq2UQ5f2v2TB2HhI8uLZ/NW6eCL5pimpfjt+A=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="Etayveqz8j1Zky906ORf.4LRv3gA1twqOkp10kfgD7W.Wj3DQs6tL/dJcycLrc2BpsqktwFovl+dfivyKETIrmg=")
ke.loginResult()
...
kh = LINETCR.LINE()
kh.login(token="EtwQzK1DPaR5ew5v7xi7.7v0zhfadF6oxy23AresKTW.7b/LFtD5BEppSTC2xfGaNqu8lwkNsbKWU4Q6SaNis3M=")
kh.loginResult()

kq = LINETCR.LINE()	
kq.login(token="EtGQcDPLopyJZzdmJSt1.tVVuNIfqBrYTb2aurxs88q.sabybjgxatiD33ZospsiGe3syiF2duKDsM9uH5PWv8A=")
kq.loginResult()

ks = LINETCR.LINE()
ks.login(token="EtjmXP13TtgB9rLLdFAa.a7vtOVsSekMA2otza4xAIG.Q/RNCnask/Yw+W7ZAkCnPInQx5XM/J+tzDzWzrA8tFE=")
ks.loginResult()

sw = LINETCR.LINE()
sw.login(token="EtBfBKnDtWoulngpNFxa.XcMocQpZGrVuWwqpEEojMG.O58peY3pZLgGnR+3IX6p2KwShS7npC/2pmI3bQl+mpk=")	
sw.loginResult()
...
Bots = [mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,"uf50d888821632d32461e37153ac775c0","u80c309fa576ebd0fd2fdb9d9b121c628","u5774907f7a0a4b1106c66fde16987d67","u604b2a0573bb0b1152fbcfdaca3fb388"]
...
#----------------Welcome---------------------------------------------
        if op.type == 15:
          if wait["goodbye"] == True:
            ...
            cl.sendText(op.param1, "isin baper hhh")
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                return
            elif msg.text in ["Help","S","Menu","Key","menu"]:
	      if msg.from_ in admin:
                if wait["lang"] == "JP":
	      ...
	      if msg.from_ in admin:
            ...
            elif "S invite " in msg.text:
	      if msg.from_ in admin:
                midd = msg.text.replace("S invite ","")
...
#---------------------------------------------------------------------------------------------
		...
		if wait["Protectgroupname"] == False:
			...
			cl.sendText(msg.to,"Gnamelock already off")
#---------------------------------------------------------------------------------------------
	    elif msg.text in ["Siri on","S on","Bot on"]:
	      if msg.from_ in admin:
                ...
                if wait["cancelprotect"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"On")
#-----------------------------------------------------------------------------------------
            elif msg.text in ["Siri off","S off","Bot off"]:
              if msg.from_ in admin:
...
#----------------------------------------------------------------------------------------------
		...
		cl.sendText(msg.to,md + "╚═════════════\n\n     🔐 🔰BOST SABLENK🔰「👻」")
	      ...
	      if msg.from_ in admin:
                ...
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"Semua undangan telah dibatalkan")
                else:
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:                                    
                                    ...
                                    cl.sendText(msg.to,"Succes boss, klo ada yg nakal  aim siap Bantai ")
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:                                    
                                    ...
                                    cl.sendText(msg.to,"Succes Boss, aim siap ciak kapanpun...!")
                                    kk.sendText(msg.to,"Bye")
                ...
                for g in gs.members:
			      ...
			      if not target in Bots and admin:
                                try:
                                    ...
                                    cl.sendText(msg.to,"error")
	    elif "S C" in msg.text:
	      if msg.from_ in admin:
                wait["blacklist"] = {}
                cl.sendText(msg.to,"Blacklist user succes dibersihkan")

            elif "S b" in msg.text:
              if msg.toType == 2:
                  if msg.from_ in admin:                                        
                       ban0 = msg.text.replace("S b","")
                       ban1 = ban0.lstrip()
                       ban2 = ban1.replace("@","")
                       ban3 = ban2.rstrip()
                       _name = ban3
